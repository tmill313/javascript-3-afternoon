...
let Taylor = new Employee('Taylor', 'Miller', "email@gmail.com", 25);
Taylor.makeWidget();
...
let Leroy = new Manager('Leroy', 'McQueen', 'leroy@gmail.com', 55);
...
var Tom = new ProgressiveManager('Tom', 'Douche', 'td@gmail.com', 95);
