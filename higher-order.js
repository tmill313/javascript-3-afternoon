...
*/
let bobsTotal = purchases.filter(x => x.owner === 'Bob').map(x => x = x.price).reduce((x, y) => x + y);
// let bobsTotals = bobsTotalss.map(x => x = x.price);
// let bobsTotal = bobsTotals.reduce((x, y) => x + y);
